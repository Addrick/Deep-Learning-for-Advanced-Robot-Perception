...
#
# Current best configuration: Test accuracy: 85.97% (7.45%)
# (0.2)>Dense(60, sig)>(0.5)>Dense(60, sig)>(0.5)>Dense(60,sig)>Dense(1,sig), 
# lr=0.15, momentum=0.7, decay=0.00005, 1200 epochs
import numpy
import pandas
...
estimators.append(('mlp', KerasClassifier(build_fn=create_model, epochs=1200, batch_size=16, verbose=2)))
