...
# parse an XML file:
    # file describes location of several objects in the image
    # parse file, alter code below to output a separate image for each object
    # each new image should go in a folder with the name of the object
    # resize images to 224x224
    # using PIL: Image.resize([224,224], PIL.Image.LANCZOS)
    
# "generate single binary file to compress the whole data" - ...a zip? other students talking about pickle but are confused as well
...
for i in range(9950):
    try:
        tree = ET.parse('C:/Users/Adam/Desktop/595/Week 5/Reduce overfitting/PascalVOC2012/VOC2012/Annotations/2007_00' + str(i).zfill(4) + '.xml')
        root = tree.getroot()
...
for i in range(8774):
    try:
        tree = ET.parse('C:/Users/Adam/Desktop/595/Week 5/Reduce overfitting/PascalVOC2012/VOC2012/Annotations/2008_00' + str(i).zfill(4) + '.xml')
        root = tree.getroot()
...
for i in range(5312):
    try:
        tree = ET.parse('C:/Users/Adam/Desktop/595/Week 5/Reduce overfitting/PascalVOC2012/VOC2012/Annotations/2009_00' + str(i).zfill(4) + '.xml')
        root = tree.getroot()
...
for i in range(6995):
    try:
        tree = ET.parse('C:/Users/Adam/Desktop/595/Week 5/Reduce overfitting/PascalVOC2012/VOC2012/Annotations/2010_00' + str(i).zfill(4) + '.xml')
        root = tree.getroot()
...
for i in range(7215):
    try:
        tree = ET.parse('C:/Users/Adam/Desktop/595/Week 5/Reduce overfitting/PascalVOC2012/VOC2012/Annotations/2011_00' + str(i).zfill(4) + '.xml')
        root = tree.getroot()
...
for i in range(4332):
    try:
        tree = ET.parse('C:/Users/Adam/Desktop/595/Week 5/Reduce overfitting/PascalVOC2012/VOC2012/Annotations/2012_00' + str(i).zfill(4) + '.xml')
        root = tree.getroot()
...
# was able to load the file structure into a 
# keras.preprocessing.image.DirectoryIterator object, but couldn't pickle it
